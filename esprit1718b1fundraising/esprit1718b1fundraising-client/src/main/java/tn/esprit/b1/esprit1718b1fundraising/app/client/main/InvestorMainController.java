 ...
 * @author danml
 */
public class InvestorMainController implements Initializable {
    ...
    @FXML
    private void showCompanies(MouseEvent event) throws IOException {
    	StackPane pane=FXMLLoader.load(getClass().getResource("/tn/esprit/b1/esprit1718b1fundraising/app/client/charity/ChPListInvestorN.fxml"));
    	rootPane.getChildren().setAll(pane);
       // setStage("/tn/esprit/b1/esprit1718b1fundraising/app/client/charity/ChPListInvestorN.fxml");
    ...
    @FXML
    void BrowseProjects(MouseEvent event) {
	    setStage("/tn/esprit/b1/esprit1718b1fundraising/app/client/gui/HomeInvestorview.fxml");
    ...
    private void setStage(String fxml) {
        try {
            ...
            Logger.getLogger(InvestorMainController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
