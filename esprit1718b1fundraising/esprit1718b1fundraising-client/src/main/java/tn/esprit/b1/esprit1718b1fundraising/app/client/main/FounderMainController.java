...
import tn.esprit.b1.esprit1718b1fundraising.app.client.gui.Routes;

public class FounderMainController implements Initializable {
	 ...
	 @FXML
	    ...
	    private void showCompanies(MouseEvent event) {
	    	//Nouha
	        setStage2("/tn/esprit/b1/esprit1718b1fundraising/app/client/charity/CreateChProjectN.fxml");
	    ...
	    setStage("/tn/esprit/b1/esprit1718b1fundraising/app/client/gui/HomeView.fxml");
	    ...
	    @FXML
	    private void synchroniseOnline(MouseEvent event) throws IOException {
	    	StackPane pane=FXMLLoader.load(getClass().getResource("/tn/esprit/b1/esprit1718b1fundraising/app/client/charity/ChProjectPrivateListFoudN.fxml"));
	    	rootPane.getChildren().setAll(pane);
	    	//setStage2("/tn/esprit/b1/esprit1718b1fundraising/app/client/charity/ChProjectPrivateListFoudN.fxml");
	    ...
	    private void setStage2(String fxml) {
	        try {
	            //dim overlay on new stage opening
	            Region veil = new Region();
	            veil.setPrefSize(1100, 650);
	    ...
	    private void showReports(MouseEvent event) throws IOException {
	    	setStage("/tn/esprit/b1/esprit1718b1fundraising/app/client/gui/showProjectFounder.fxml");
