...
public class AdminController implements Initializable {
    ...
    public void showAbout() {
        setStage("ProfilManage.fxml");
    }

    @FXML
    private void showCompanies(MouseEvent event) {
        setStage("/tn/esprit/b1/esprit1718b1fundraising/app/client/gui/FXMLDocument.fxml");
    ...
    private void showReports(MouseEvent event) {
    	setStage2("/tn/esprit/b1/esprit1718b1fundraising/app/client/charity/ConfirmListAdmin.fxml");
    }
    ...
    private void setStage2(String fxml) {
        try {
           ...
           //Parent parent = FXMLLoader.load(getClass().getResource(fxml));
            ...
            scene.setFill(Color.TRANSPARENT);
            scene.getStylesheets().add("../charity/style.css");
            newStage.setScene(scene);
            newStage.initModality(Modality.APPLICATION_MODAL);
            newStage.initStyle(StageStyle.TRANSPARENT);
            newStage.getScene().getRoot().setEffect(new DropShadow());
