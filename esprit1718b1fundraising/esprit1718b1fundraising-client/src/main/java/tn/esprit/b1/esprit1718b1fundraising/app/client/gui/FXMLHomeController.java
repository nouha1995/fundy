...
public class FXMLHomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            AnchorPane BusinessPane = FXMLLoader.load(getClass().getResource(Routes.BUSINESSPROJECT));
            AnchorPane PlanPane = FXMLLoader.load(getClass().getResource(Routes.PLANE));
            //AnchorPane payments = FXMLLoader.load(getClass().getResource(Routes.SHOWPROJECT));
